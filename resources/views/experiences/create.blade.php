            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Experience Name">
                        @error('title')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Experience Detail:</strong>
                        <input type="text" name="subtitle" class="form-control" placeholder="Experience Detail">
                        @error('subtitle')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="10" cols="50" name="paragraph" class="form-control" placeholder="Summary"></textarea>
                        @error('paragraph')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
